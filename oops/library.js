class BookLibrary{
        books = {        "randamoozham": { book_name: "randamoozham", price: 470, author: "mt vasudhevan", avl_copies: 100, sold_copies: 100 },
    ...
        findBook(book_name){
        ...
        {
           console.log(this.books[this.books.book_name==book_name]);
        }
        }    
}
